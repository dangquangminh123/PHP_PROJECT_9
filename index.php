    ...
    <nav class="navbar navbar-expand-lg navbar-dark default-color">
        ...
        <ul class="navbar-nav ml-auto nav-flex-icons">
            ...
            <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown"
                ...
                <i class="fas fa-user mr-2"><?php ?></i>Account
            </a>
            <div class="dropdown-menu dropdown-menu-right dropdown-default"
                aria-labelledby="navbarDropdownMenuLink-333">
                <a class="dropdown-item" href="/School_manager/admin/dashboard.php">Dashboard</a>
                <a class="dropdown-item" href="#">Another action</a>
        ...
        <div class="container-fluid my-2">
            <div class="row">
                <div class="col-lg-6 my-auto">
                    <h1 class="display-3 font-weight-bold">School Managemnt System</h1>
                    ...
                    <div class="col-lg-8 mx-auto card shadow-lg">
                        <div class="card-body py-5">
                            ...
                            <form action="" method="post" class="">
                                ...
                                <label for="message">Your Class</label>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 py-5">
                    ...
                    <div class="pr-5">
                        <p>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident animi error dolorum autem dolores.
                             Quod voluptate quaerat error architecto iste distinctio,
                             accusantium accusamus tenetur officia, dolore vel repellendus dolores placeat!
                             accusantium accusamus tenetur officia, dolore vel repellendus dolores placeat!
                             accusantium accusamus tenetur officia, dolore vel repellendus dolores placeat!
                        </p>
                        <p>
...
<style>
    ...
    <section class="py-5 bg-light">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis cupiditate fugit placeat iusto dolor earum.</p>
        </div>

        <div class="container">
            <div class="row">
                <?php 
                    $query = mysqli_query($db_conn, "SELECT * FROM courses ORDER BY id DESC LIMIT 0, 10");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 pr-5">
                        <h2>Achievements</h2>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore placeat
                             laudantium nostrum rem odio consectetur inventore itaque architecto.</p>
    ...
    <section class="py-5">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt fugiat earum pariatur, 
                necessitatibus laborum magni!</p>
        </div>
       <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="border rounded position-relative">
                        <div class="p-4 text-center">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum molestias recusandae dignissimos perspiciatis sint vitae
                            sed! At nisi incidunt quae itaque 
                            maxime odit, accusamus esse quibusdam quis amet cupiditate. Distinctio.
                        </div>
    ...
    <section class="py-2 bg-dark text-light">
        <div class="container-fluid">
        Copyright By Biến thể PHP 2022-2023 All Rights Reseved. <a href="#" class="text-light">School Management System</a>
        </div>
    </section>
